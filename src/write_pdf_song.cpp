...
void write_preamble(std::ofstream& fout) {
	...
	fout << "\\documentclass[a4paper,portrait]{article}\n"
	...
	fout << "\\fancyfoot[C]{} \n"
		...
		<< "\\renewcommand\\headrulewidth{0.02in}\\renewcommand\\footrulewidth{0.02in}\\Needspace{5\\baselineskip}\n"
